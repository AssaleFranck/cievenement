                    ...
                    <div class="card-body ">
                        <form   class="d-flex flex-column align-items-center" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-floating mb-3 w-75">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" min="4" placeholder="votre nom" required autofocus>
                            ...
                            <div class="form-floating mb-3 w-75">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"  placeholder="nom@exemple.com" required>
                            ...
                            <div class="form-floating mb-3 w-75">
                                <input id="phone" type="phone" class="form-control @error('phone') is-invalid @enderror" name="phone" min="10" placeholder="1234567890 ou 2251234567890" required>
                            ...
                            <div class="form-floating mb-3 w-75">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" min="8" placeholder="+8 caractères" required>
                            ...
                            <div class="form-floating mb-3 w-75">
                                <input id="password-confirm" type="password" class="form-control @error('password') is-invalid @enderror" name="password_confirmation"  placeholder="+8 caractères" required>
